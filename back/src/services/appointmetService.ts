...
export const getAppointmentServices = async (userId: number | null): Promise<Appointment[]> =>{
    ...
    const appointment: Appointment[] =  await AppDataSource.getRepository(Appointment).find(options);
    return appointment;
};
